      ...
      <div id="main-bar"
        ...
        <div class="mx-auto sm:w-[70%] w-[90%] flex justify-between items-center">
          <div id="logo-header" class="max-w-[12rem] justify-start">
            <router-link to="/">
              <img src="/assets/images/identity/logo-light-creole.png" alt="tshanic-logo"
        ...
        <div class="mx-auto lg:w-[70%] w-full flex justify-between items-center">
          <div
            ...
            <div id="mobile-menu" class="sm:hidden flex flex-row float-right justify-end"
              ...
              <i class="pi pi-bars content-center cursor-pointer -mt-0.5"
            ...
            <div
              ...
              <div class="flex w-[88%]">
                <AutoComplete v-model="searchTerm" :suggestions="filteredData" @complete="search"
                              @option-select="view(searchTerm)" optionLabel="name"
                              scroll-height="220px"
                              :virtualScrollerOptions="{ itemSize: 32 }" overlayClass="w-[96%] mx-2"
                              fluid
              ...
              <div class="w-[12%] flex items-center justify-center">
                <span class="pi pi-search-plus cursor-pointer"
                      style="font-size: 16px; padding-left: 1px;"></span>
              </div>
            </div>
          </div>
